...
export function getImageModelConfig(model) {
  if (model === 'image2') {
    const base = process.env.IAMGE2_API_BASE || process.env.VECTORENGINE_API_BASE || 'https://api.vectorengine.cn/v1';
...
export function getAvailableModels() {
  ...
  if (process.env.IMAGE2_KEY && process.env.IMAGE2_MODEL) {
