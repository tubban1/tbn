...
export function getImageModelConfig(model) {
  if (model === 'image2') {
    const base = process.env.IMAGE2_API_BASE || process.env.IAMGE2_API_BASE || process.env.VECTORENGINE_API_BASE || 'https://api.frimodel.com/v1';
  ...
  const base = process.env.VECTORENGINE_API_BASE || 'https://api.frimodel.com/v1';
